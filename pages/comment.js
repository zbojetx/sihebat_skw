					...
					<View style={{ padding: 20 }}>
						<View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
							...
							<View style={{ marginLeft: 20, flex: 0.9 }}>
								<Text style={{ fontSize: 14, color: Colors.BLACK, fontFamily: Fonts.LIGHT }}>Ingin perayaan Imlekmu lebih unik? Nah, kamu juga bisa mengikuti Cap Go Meh Run yang merupakan bagian festival Cap Go Meh</Text>
