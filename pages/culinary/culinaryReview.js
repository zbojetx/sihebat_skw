...
export default class PlaceCategoryList extends Component {
	...
	handleBackButton = () => {
		Actions.culinaryDetail({culinaryId: this.props.culinaryId})
		return true;
	};
    ...
    postReview() {
        ...
        axios({
            method: 'PUT',
            url: Config.API_URL + '/api/v1/culinary/review',
            data: {
			...
			<Container>
				...
				<Content style={{ backgroundColor: Colors.WHITE }}>
                    <View style={{ padding: 10 }}>
                        <Text style={{ marginTop: 10, fontWeight: '500', fontSize: 16 }}>{this.props.culinaryName}</Text>
